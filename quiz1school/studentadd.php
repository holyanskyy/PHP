...
function getForm($mm = '', $yy = '', $pp = '', $gg = '') {

    $f = <<< TAGS
<h3>Add Student</h3>
<form method="post">
    Name: <input type="text" name="name" value="$mm"><br>
    Age: <input type="number" name="age" value="$yy"><br>
    GPA: <input type="text" name="gpa" value="$pp"><br>
    Has graduated? <input type="checkbox" name="hasGraduated" value="$gg"><br>
...
if (!isset($_POST['name'])) { 
    ...
    if ($errorList) {
        ...
        $sql = sprintf("INSERT INTO student VALUES (NULL, '%s', '%s', '%d', '%s')", 
